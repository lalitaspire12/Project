<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Air_Tick.aspx.cs"
    Inherits="Default15" Title="Untitled Page" %>
    <asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        <br />
        <br />
        <asp:Panel ID="Panel2" runat="server" BorderColor="Red" BorderStyle="Double" Font-Size="Medium" Height="287px"
            Style="left: 406px; position: absolute; top: 238px" Width="470px">
            ...
            <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Overline="True" Font-Size="Larger"
                ...
                top: 8px" Text="<center>Bus Ticket" Width="183px"></asp:Label>
            ...
            <asp:Label ID="Label5" runat="server" BackColor="White" BorderColor="#FF8000" BorderStyle="Solid"
                BorderWidth="1px" Font-Bold="True" Font-Size="Small" Height="19px" Style="left: 15px;
                position: absolute; top: 128px" Text="<center>Ticket Number:" Width="110px"></asp:Label>
        </asp:Panel>
        ...
        <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Overline="True" Font-Size="XX-Large"
            ...
            top: 194px" Text="<center>Aspire Systems" Width="297px"></asp:Label>
        <br />
        <br />
        <br />
        <br />
